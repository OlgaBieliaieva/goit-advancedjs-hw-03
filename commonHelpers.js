import{a as g,S as p,i as h,P as u,N as d}from"./assets/vendor-2cd1003f.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))t(a);new MutationObserver(a=>{for(const l of a)if(l.type==="childList")for(const s of l.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&t(s)}).observe(document,{childList:!0,subtree:!0});function n(a){const l={};return a.integrity&&(l.integrity=a.integrity),a.referrerpolicy&&(l.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?l.credentials="include":a.crossorigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function t(a){if(a.ep)return;a.ep=!0;const l=n(a);fetch(a.href,l)}})();const v="https://api.thecatapi.com/v1/breeds/?",m=" https://api.thecatapi.com/v1/images/search?",o={api_key:"live_4OV6mO4kCm8Wvp0obaFUUKjV7Fg0aDGCrA5iSKIh93pBZ22atpg8saVdJ0BQ988s",breed_ids:""};async function f(){const i=new URLSearchParams(o);try{return(await g.get(`${v}${i}`)).data}catch(e){console.log(e)}}async function w(i){o.breed_ids!==i&&(o.breed_ids=i);const e=new URLSearchParams({...o,limit:15});try{return(await g.get(`${m}${e}`)).data}catch(n){console.log(n)}}const r={searchSelect:document.querySelector(".breed-select"),searchResult:document.querySelector(".cat-info"),swiperContainer:document.querySelector(".swiper-container"),swiper:document.querySelector(".swiper"),swiperWrapper:document.querySelector(".swiper-wrapper"),descriptionWrapper:document.querySelector(".description-container"),loader:document.querySelector(".loader")};r.searchSelect.addEventListener("change",b);f().then(i=>y(i)).catch(()=>c());function y(i){const e=i.map(({id:n,name:t})=>`<option class="breed-option" value="${n}">${t}</option>`).join("");r.searchSelect.insertAdjacentHTML("beforeend",e)}function b(i){r.loader.classList.remove("visually-hidden");const e=i.target.value;e!==""?(r.swiperContainer.classList.add("visually-hidden"),r.descriptionWrapper.innerHTML="",r.swiperWrapper.innerHTML="",w(e).then(n=>L(n)).catch(n=>c())):(r.descriptionWrapper.innerHTML="",r.swiperContainer.innerHTML="",r.loader.classList.add("visually-hidden"))}function L(i){const e=i[0].breeds[0],n=i.map(s=>s.url),t=[1,2,3,4,5],a=n.map(s=>`        
